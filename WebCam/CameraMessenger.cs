...
namespace VeterinaryManagementSystem.UIWebCam
{
    public class CameraMessenger
    {
        ...
        private static CameraMessenger _instance;

        /// <summary>
        /// Gets the single instance of the Messenger.
        /// </summary>
        public static CameraMessenger Default
        {
            get
            {
                if (_instance == null)
